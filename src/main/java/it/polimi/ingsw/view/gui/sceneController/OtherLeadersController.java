...
/**
 * Handles the scene which shows other players' Leader cards
 */
public class OtherLeadersController extends GuiController {
    ...
    public void backUpdate(Event event) {
        ...
        Platform.runLater(GuiController::fastBackInOtherPlayerBoard);
    }
}
