...
/**
 * Handles Board scene, including the depots, strongbox and Extra depots to store resources, acquired Development cards
 * and the FaithTrack, including Pope favors
 */
public class BoardController extends GuiController {
    @FXML
    public Button marketBtn;
    @FXML
    public Button devCardTrayBtn;
    @FXML
    public Button leadersBtn;
    @FXML
    public Button otherPlayersBtn;
    @FXML
    ...
    public void initialize() {
        ...
        marketBtn.addEventHandler(MouseEvent.MOUSE_CLICKED, this::showUpdate);
        devCardTrayBtn.addEventHandler(MouseEvent.MOUSE_CLICKED, this::showUpdate);
        leadersBtn.addEventHandler(MouseEvent.MOUSE_CLICKED, this::showUpdate);
        otherPlayersBtn.addEventHandler(MouseEvent.MOUSE_CLICKED, this::showUpdate);
    ...
    public void showUpdate(Event event) {
        ...
        switch (clickedBtn) {
            case "marketBtn":
                sender.send(new ShowMarketTrayRequest(nickname));
                break;

            case "devCardTrayBtn":
                sender.send(new ShowDevCardTrayRequest(nickname));
                break;

            case "leadersBtn":
                sender.send(new ShowLeadersRequest(nickname));
                break;

            case "otherPlayersBtn":
                sender.send(new ShowOtherPlayerRequest(nickname));
                break;

            default:
                marketBtn.setDisable(false);
                devCardTrayBtn.setDisable(false);
                leadersBtn.setDisable(false);
                otherPlayersBtn.setDisable(false);
                break;
